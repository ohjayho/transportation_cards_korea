...
export default function Home() {
  return (
    <>
      <div className="w-full h-full flex justify-center items-center bg-[url('/bg.jpg')] bg-cover bg-right-bottom overflow-x-hidden">
        <div className="h-[80%] flex flex-col items-center relative mt-28 max-sm:mt-10">
          <div className="flex">
